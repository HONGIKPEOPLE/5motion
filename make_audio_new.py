...
def convert_video_to_audio(video_folder, start_frame, end_frame):
    ...
    audio_filename = f"M09_S{str(video_folder[-3:]).zfill(4)}.wav"   ###  수정사항 1
    ...
    for folder in folders:
        ...
        with open(csv_file_path, 'r') as csv_file:
            ...
            for row in csv_reader:
                ...
                if convert_video_to_audio(folder, start_frame, end_frame):
